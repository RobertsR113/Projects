...
### Goal:
To showcase my knowledge and skillset in Java acquired from my 1st year study course, Java-Fundamentals.
...
2. Download `IntelliJ`
3. In IntelliJ: Click on `Open` -> Select `console-bank-simulator`
